...
gene_based_data_files = [
    {
        ...
        "gencode_version": 35,
        "gene_based": {
            "file": "gs://daly-genetics-results/exome_results/genebass/gene_burden_results.mlog10p_gt4.tsv.gz",
            "prefix": "gs://daly-genetics-results/exome_results/genebass/gene_burden_per_trait/",
            "suffix": ".tsv.gz",
        },
    },
    {
        ...
        "gencode_version": 39,
        "gene_based": {
            "file": "gs://daly-genetics-results/exome_results/schema/SCHEMA2_gene_results.munged.tsv.gz",
            "prefix": "gs://daly-genetics-results/exome_results/schema/gene_burden_per_trait/",
            "suffix": ".tsv.gz",
        },
    },
    {
        ...
        "gencode_version": 39,
        "gene_based": {
            "file": "gs://daly-genetics-results/exome_results/bipex/BipEx2_gene_results.munged.tsv.gz",
            "prefix": "gs://daly-genetics-results/exome_results/bipex/gene_burden_per_trait/",
            "suffix": ".tsv.gz",
        },
    },
    {
        ...
        "gencode_version": 45,
        "gene_based": {
            "file": "gs://daly-genetics-results/exome_results/ibd/IBD_exome_IBD_gene_results.munged.tsv.gz",
    ...
    },
    {
        ...
        "gencode_version": 45,
        "gene_based": {
            "file": "gs://daly-genetics-results/exome_results/ibd/IBD_exome_UC_gene_results.munged.tsv.gz",
            "prefix": "gs://daly-genetics-results/exome_results/ibd/gene_burden_per_trait/",
            "suffix": ".tsv.gz",
        },
    },
