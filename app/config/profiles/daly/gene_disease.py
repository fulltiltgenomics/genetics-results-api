"""Daly profile: gene-disease data paths."""

gene_disease = {
    "gencc": {
        "file": "gs://daly-genetics-results/gene_disease/gencc-submissions-export-tsv",
        "columns": {
            "uuid": "uuid",
    ...
    "monarch": {
        "file": "gs://daly-genetics-results/gene_disease/monarch-causal_gene_to_disease_association.all.tsv",
        "columns": {
            "uuid": "uuid",
