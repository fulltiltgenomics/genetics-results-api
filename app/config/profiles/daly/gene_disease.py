...
gene_disease = {
    "gencc": {
        "file": "gs://daly-genetics-results/gene_disease/gencc-submissions-export.2026-09-12.tsv",
        "columns": {
            "uuid": "uuid",
    ...
    "monarch": {
        "file": "gs://daly-genetics-results/gene_disease/monarch-gene_to_disease.2026-09-02.tsv",
