"""FinnGen profile: variant-effect (Product B) data paths.
...
variant_effect_data = [
    {
        ...
        "version": "2026",
        "file": "gs://finngen-commons/results_api_data/variant_effect/marderstein/marderstein_chrombpnet.tsv.gz",
    },
    {
        "data_source": "gcloud",
        "resource": "marderstein",
        ...
        "version": "2026",
        "file": "gs://finngen-commons/results_api_data/variant_effect/marderstein/marderstein_flare.tsv.gz",
    },
]
